...
<div id="wrap">
	<%
		...
		String query = "SELECT 문구.문구,출처.제목,인물.이름 FROM 문구,출처,인물 WHERE 문구.출처ID = 출처.출처ID AND 문구.인물ID = 인물.인물ID AND 문구.유저ID = '"+userID+"';";
		rs = stmt.executeQuery(query);
	%>
		<h1><%=userID %>님이 저장한 문구입니다</h1>
		<br>
		<table border="1">
			<tr>
